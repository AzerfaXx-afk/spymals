            ...
            <div className="z-10 text-center max-w-md mx-auto px-4 relative">
                ...
                <div className="w-full bg-slate-950/90 border-2 border-white/15 rounded-3xl p-3.5 mb-4 shadow-[0_12px_35px_rgba(0,0,0,0.7)] text-left relative overflow-hidden">
                    ...
                    <div className={`p-3.5 rounded-2xl border-2 ${activeBannerObj.class} flex items-center justify-between shadow-md relative overflow-hidden`}>
                        ...
                        <div className="bg-slate-950/80 border border-white/20 px-2.5 py-1 rounded-xl text-[8.5px] font-black text-white/90 uppercase tracking-wider shadow-sm flex items-center gap-1">
                            <Sparkles className="w-3 h-3 text-spy-lime" />
                            <span>TEST LIVE</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                        ...
                        USERNAME_COLORS.filter(c => c.price > 0).map(color => {
                            ...
                            return (
                                <div 
                                    ...
                                    className={`bg-slate-950/80 border-2 rounded-2xl p-3 flex items-center justify-between shadow-md transition-all duration-200 cursor-pointer group ${
                    ...
                    {selectedTab === 'themes' && (
                        THEMES_LIST.filter(t => t.price > 0).map(theme => {
                            ...
                            const IconComp = theme.IconComponent || Sparkles;
