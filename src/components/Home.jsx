        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center relative overflow-hidden bg-spy-blue touch-none">
            ...
            <div className="z-10 w-full max-w-sm space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <BouncyButton variant="secondary" onClick={onOpenHowToPlay} className="text-sm py-4 flex flex-col items-center justify-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                        </svg>
                        COMMENT JOUER
                    </BouncyButton>
                    <BouncyButton variant="secondary" onClick={onOpenSettings} className="text-sm py-4 flex flex-col items-center justify-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
