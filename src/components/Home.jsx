...
const Home = ({ onStartGame, onOpenSettings, onOpenHowToPlay }) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center relative overflow-hidden bg-spy-blue touch-none">
            ...
            <div className="z-10 flex flex-col items-center mb-12 animate-bounce-slow">
                <div className="text-8xl mb-4 filter drop-shadow-xl transform hover:rotate-12 transition-transform cursor-pointer active:scale-90 duration-200">
                    🕵️‍♂️
                </div>
                <h1 className="text-6xl font-black text-white tracking-tighter drop-shadow-lg font-display select-none">
